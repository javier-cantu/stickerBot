// sb012_timerDeArranque.js
// ahora quiero un timer para ver cuanto se tarda en cargar el json. 
// A lo mejor timer para ver cuanto se tarda en procesar las busquedas. 
            ...
            if (palabrasClave) {
                ...
                if (resultados.length > 0) {
                    ...
                    if (resultados.length > 5) {
                        message.reply(
                            `Encontré ${resultados.length} stickers con esas palabras clave y te mando 5 aleatorios de estos:\n${listaEnumerada}`
                        );
                    } else {
                        message.reply(
