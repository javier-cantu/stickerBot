// sb013_timerDeBusqueda.js
// ahora quiero un timer para ver cuanto se tarda en cargar el json. 
// Y ahora timer en la consola de cuanto se tarda en buscar cuando detecta el comando. 
    ...
    if (message.fromMe) {
        ...
        if (comando.startsWith('quiero stickers de')) {
            ...
            if (palabrasClave) {
                ...
                console.log('Ejecutando comando: quiero stickers de');
