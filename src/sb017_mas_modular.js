// sb017_mas_modular.js
// quiero organizar el codigo para que sea mas modular y manejable
...
client.on('message', async (message) => {
    ...
    if (comando.startsWith('quiero stickers de')) return manejarQuieroStickers(message, comando);
